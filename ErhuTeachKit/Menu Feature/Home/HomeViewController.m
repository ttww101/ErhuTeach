...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"教你拉二胡";
...
- (void)setContainerViewController {
    ErhuInfoVC *vc1 = [ErhuInfoVC new];
    [self.mContainerVCArr addObject:vc1];
    ErhuPracticeVC *vc2 = [ErhuPracticeVC new];
    [self.mContainerVCArr addObject:vc2];
    ErhuVideoVC *vc3 = [ErhuVideoVC new];
...
- (UIColor *)tabBarColor {
    return [UIColor colorWithRed:164.0/255.0 green:19.0/255.0 blue:0.0/255.0 alpha:1.0];
}
...
- (void)setupNavigationStyle {
    NavigationTheme *theme = [[NavigationTheme alloc]
                              ...
                              //bar color
                              barColor:[UIColor colorWithRed:164.0/255.0 green:19.0/255.0 blue:0.0/255.0 alpha:1.0]
                              //title font, size
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    if(section == 0){
        ...
        UIColor *bgColor = [UIColor colorWithPatternImage: [UIImage imageNamed:@"erhu_bg"]];
